variable "iso_checksum" {
  type    = string
  default = "sha256:3eebd50aabe93b9cbea3937dcf5e1d893e397a36de128ae60a8d46ff048fa0d6"
}
...
variable "iso_url" {
  type    = string
  default = "https://raw.repo.almalinux.org/vault/9.1/isos/x86_64/AlmaLinux-9.1-x86_64-minimal.iso"
}
...
variable "vm_name" {
  type    = string
  default = "almalinux-9-1-x64-fr-server-template"
}
