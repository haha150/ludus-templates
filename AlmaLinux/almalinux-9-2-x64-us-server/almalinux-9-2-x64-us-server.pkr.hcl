variable "iso_checksum" {
  type    = string
  default = "sha256:51ee8c6dd6b27dcae16d4c11d58815d6cfaf464eb0e7c75e026f8d5cc530b476"
}
...
variable "iso_url" {
  type    = string
  default = "https://raw.repo.almalinux.org/vault/9.2/isos/x86_64/AlmaLinux-9.2-x86_64-minimal.iso"
}
...
variable "vm_name" {
  type    = string
  default = "almalinux-9-2-x64-us-server-template"
}
