variable "iso_checksum" {
  type    = string
  default = "sha256:20123bb9f8319143e792b906137236bdcb0d10b023c36626ca2d8e9f62144eb9"
}
...
variable "iso_url" {
  type    = string
  default = "https://raw.repo.almalinux.org/vault/9.4/isos/x86_64/AlmaLinux-9.4-x86_64-minimal.iso"
}
...
variable "vm_name" {
  type    = string
  default = "almalinux-9-4-x64-fr-server-template"
}
