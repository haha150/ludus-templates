...
variable "vm_name" {
  type    = string
  default = "centos-7.9.2009-x64-fr-server-template"
}
...
locals {
  template_description = "CentOS 7.9.2009 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}
