variable "iso_checksum" {
  type    = string
  default = "sha256:c79921e24d472144d8f36a0d5f409b12bd016d9d7d022fd703563973ca9c375c"
}
...
variable "iso_url" {
  type    = string
  default = "http://mirror.nsc.liu.se/centos-store/centos/8.4.2105/isos/x86_64/CentOS-8.4.2105-x86_64-boot.iso"
}
...
variable "vm_name" {
  type    = string
  default = "centos-8.4.2105-x64-us-server-template"
}
...
locals {
  template_description = "CentOS 8.5.2111 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}
