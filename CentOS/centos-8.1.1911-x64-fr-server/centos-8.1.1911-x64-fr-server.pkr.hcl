variable "iso_checksum" {
  type    = string
  default = "sha256:7fea13202bf2f26989df4175aace8fdc16e1137f7961c33512cbfad844008948"
}
...
variable "iso_url" {
  type    = string
  default = "http://mirror.nsc.liu.se/centos-store/centos/8.1.1911/isos/x86_64/CentOS-8.1.1911-x86_64-boot.iso"
}
...
variable "vm_name" {
  type    = string
  default = "centos-8.1.1911-x64-fr-server-template"
}
...
locals {
  template_description = "CentOS 8.1.1911 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}
