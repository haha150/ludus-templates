variable "iso_checksum" {
  type    = string
  default = "sha256:a7993a0d4b7fef2433e0d4f53530b63c715d3aadbe91f152ee5c3621139a2cbc"
}
...
variable "iso_url" {
  type    = string
  default = "https://vault.centos.org/8.0.1905/isos/x86_64/CentOS-8-x86_64-1905-boot.iso"
}
...
variable "vm_name" {
  type    = string
  default = "centos-8.0.1905-x64-us-server-template"
}
...
locals {
  template_description = "CentOS 8.0.1905 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}
