variable "iso_checksum" {
  type    = string
  default = "sha256:2b801bc5801816d0cf27fc74552cf058951c42c7b72b1fe313429b1070c3876c"
}
...
variable "vm_name" {
  type    = string
  default = "centos-8.3.2011-x64-us-server-template"
}
...
locals {
  template_description = "CentOS 8.3.2011 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}
