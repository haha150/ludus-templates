variable "iso_checksum" {
  type    = string
  default = "sha256:ad1d70637c42da3a011ae0c12c3cd1f54b311bed17a23047dc834b0b30e1a521"
}
...
variable "iso_url" {
  type    = string
  default = "https://vault.centos.org/centos/8-stream/isos/x86_64/CentOS-Stream-8-20240603.0-x86_64-boot.iso"
}
...
variable "vm_name" {
  type    = string
  default = "centos-8-stream-x64-fr-server-template"
}
...
locals {
  template_description = "CentOS 8-stream template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => localuser:password"
}
