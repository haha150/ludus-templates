variable "iso_checksum" {
  type    = string
  default = "sha256:fa0f1d80034bf4a39225ea1737d6a03898c2e419919134d88d7cd1b3f8ced467"
}
...
variable "iso_url" {
  type    = string
  default = "https://software-static.download.prss.microsoft.com/dbazure/888969d5-f34g-4e03-ac9d-1f9786c66749/22631.2428.231001-0608.23H2_NI_RELEASE_SVC_REFRESH_CLIENTENTERPRISEEVAL_OEMRET_x64FRE_fr-fr.iso"
}
...
variable "vm_name" {
  type    = string
  default = "win11-23h2-x64-fr-enterprise-template"
}
