...
variable "iso_url" {
  type    = string
  default = "https://software-download.microsoft.com/download/pr/17763.737.190906-2324.rs5_release_svc_refresh_SERVER_EVAL_x64FRE_fr-fr_1.iso"
}
...
variable "vm_name" {
  type    = string
  default = "win2019-server-x64-fr-no-security-updates-template"
}
...
source "proxmox-iso" "win2019-server-x64-fr-no-security-updates" {
...
build {
  sources = ["source.proxmox-iso.win2019-server-x64-fr-no-security-updates"]
